...
ExecStatus H2OtoHHO::LoadLocale(String locale)
{
  ...
  //subMenuItem item1, item2;

  //item1.insert(1, string("MENU0_ITEM1") );
  //item2.insert(2, "MENU0_ITEM2");
  /*
		this->MainMenuList = { 
		  {1, "MENU0_ITEM1"}, 
      {2, "MENU0_ITEM2"}
  ...
  //MainMenuList->insert(new subMenuItem() );
  //MainMenuList->insert(MainMenuList->end());
  MainMenuList.insert(menuList(1));
  //MainMenuList->insert(menuList(1, new subMenuItem());
  //}
